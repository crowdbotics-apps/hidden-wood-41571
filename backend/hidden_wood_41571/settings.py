"""
Django settings for hidden_wood_41571 project.
...
ROOT_URLCONF = 'hidden_wood_41571.urls'
...
WSGI_APPLICATION = 'hidden_wood_41571.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_wood_41571 API",
    "DESCRIPTION": "API documentation for hidden_wood_41571 App",
    "VERSION": "v1",
}
